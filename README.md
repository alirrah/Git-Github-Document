...
<p style="text-align: center"><img src="./git-help.png" alt="save file in git"></p>
...
<p style="text-align: center"><img src="./git-flag.png" alt="save file in git"></p>
...
<p style="text-align: center; width: 100%;"><img src="./git-push.png" alt="save file in git"></p>
...
<p style="text-align: center"><img src="./git-push-h.png" alt="save file in git"></p>
